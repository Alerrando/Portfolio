    ...
    <header className="w-full bg-princ flex justify-center">
      <div className="w-[92%] alinhamento justify-between py-2">
        <div className="w-[45px] h-[45px]">
          <img src={logo} alt="icone do site" className="w-full h-full" />
        </div>

        <nav className="absolute h-screen w-48 block top-0 right-0 md:relative md:h-full md:flex md:w-auto">
        ...
        <List className="block md:hidden" size={32} weight="bold" />
      </div>
    </header>
  );
}
